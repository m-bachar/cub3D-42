...
/*   Updated: 2023/10/01 02:42:01 by obouya           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_init_vars(t_cub3D *cub3d)
{
	...
	cub3d->ray->is_ray_down = ft_calloc((cub3d->w_width + 1), sizeof(double));
	cub3d->ray->is_ray_up = ft_calloc((cub3d->w_width + 1), sizeof(double));
	cub3d->ray->is_ray_right = ft_calloc((cub3d->w_width + 1), sizeof(double));
	cub3d->ray->is_ray_left = ft_calloc((cub3d->w_width + 1), sizeof(double));
