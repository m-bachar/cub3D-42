...
/*   Updated: 2023/09/28 19:25:03 by obouya           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 	{
// 		cub3d->x_tile =((cub3d->xp_c / cub3d->tile) + 1) * cub3d->tile;
// 		cub3d->y_tile = cub3d->yp_c - ((cub3d->x_tile - cub3d->xp_c) * fabs(tan((2 * M_PI) - cub3d->rad_a)));
// 		cub3d->dx_step = cub3d->tile;
// 		cub3d->dy_step = (cub3d->tile * fabs(tan((2 * M_PI) - cub3d->rad_a)));
...
// 				break;
// 			}
// 				// my_mlx_pixel_put(cub3d,new_h_x,new_h_y,0X000000);
// 				new_h_x += cub3d->dx_step;
// 				new_h_y -= cub3d->dy_step;
// 		}
// 				if(new_h_y < 0)
...
// 		{
// 			cub3d->x_tile =((cub3d->xp_c / cub3d->tile)) * cub3d->tile;
// 			cub3d->y_tile = cub3d->yp_c + ((cub3d->xp_c - cub3d->x_tile) * fabs(tan((2 * M_PI) - cub3d->rad_a)));
// 			cub3d->dx_step = cub3d->tile;
// 			cub3d->dy_step = (cub3d->tile * fabs(tan((2 * M_PI) - cub3d->rad_a)));
// 		}
// 		new_h_x = 	cub3d->x_tile - 0.01;
