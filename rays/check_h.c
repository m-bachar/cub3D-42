...
/*   Updated: 2023/09/28 19:24:46 by obouya           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// 			// puts("shht");
// 			cub3d->x_tile = (((cub3d->xp_c / cub3d->tile) + 1) * cub3d->tile)+cub3d->radius;
...
// 		{
// 			cub3d->y_tile = ((cub3d->yp_c / cub3d->tile)) * cub3d->tile;
// 			cub3d->x_tile = cub3d->xp_c;
// 			cub3d->dy_step = cub3d->tile - 0.01;
// 			cub3d->dx_step = 0;
// 		}
// 		else
// 		{
// 			cub3d->y_tile = ((cub3d->yp_c / cub3d->tile)) * cub3d->tile;
// 			cub3d->x_tile = cub3d->xp_c + ((cub3d->yp_c - cub3d->y_tile) / fabs(tan((2 * M_PI) - cub3d->rad_a)));
// 			cub3d->dy_step = cub3d->tile;
// 			cub3d->dx_step = (cub3d->tile / fabs(tan((2 * M_PI) - cub3d->rad_a)));
// 		}
// 		new_h_x = cub3d->x_tile;
...
// 				new_h_x += cub3d->dx_step;
// 				new_h_y -= cub3d->dy_step;
// 				if (new_h_x> cub3d->tile * cub3d->map_x_max)
// 					new_h_x= cub3d->tile * cub3d->map_x_max;	
...
// 		{
// 			cub3d->y_tile = ((cub3d->yp_c / cub3d->tile) + 1) * cub3d->tile;
// 			cub3d->x_tile = cub3d->xp_c + ((cub3d->y_tile - cub3d->yp_c) / fabs(tan(cub3d->rad_a)));
// 			cub3d->dy_step = cub3d->tile;
// 			cub3d->dx_step = (cub3d->tile / fabs(tan(cub3d->rad_a)));
// 		}
// 		 new_h_x = cub3d->x_tile;
// 		 new_h_y =cub3d->y_tile + 0.01;
// 		while (new_h_x >= 0 && (new_h_x < cub3d->tile * cub3d->map_x_max) && new_h_y >= 0 && new_h_y < (cub3d->tile * cub3d->map_y_max))
...
// 	{
// 		cub3d->y_tile = ((cub3d->yp_c / cub3d->tile) + 1) * cub3d->tile;
// 		cub3d->x_tile = cub3d->xp_c - ((cub3d->y_tile - cub3d->yp_c) / fabs(tan((2 * M_PI) - cub3d->rad_a)));
// 		cub3d->dy_step = cub3d->tile;
// 		cub3d->dx_step = (cub3d->tile / fabs(tan((2 * M_PI) - cub3d->rad_a)));
// 		new_h_x = cub3d->x_tile;
// 		new_h_y =cub3d->y_tile + 0.01;
